...
export const API_URL = process.env.REACT_APP_API_URL || "http://localhost:3000/chat-api";
export const WS_URL = process.env.REACT_APP_WS_URL || "http://localhost:3000/Hub";
